...
class PopularSectionWidget extends StatelessWidget {
  ...
  const PopularSectionWidget({super.key, required this.categories, required this.ranking});
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      const Padding(
        ...
        child: Text('오늘의 인기 CHALLENGE 🔥', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
      ),
      ...
      Container(
        ...
        decoration: BoxDecoration(
          color: const Color(0xFFFFB0B0), // 핑크 박스 느낌
        ...
        child: Column(
          children: [
            for (var i = 0; i < ranking.length; i++)
              ChallengeTileWidget(
                c: ranking[i],
                background: const Color(0xFFFFB0B0), // 컨테이너와 톤 맞추기
